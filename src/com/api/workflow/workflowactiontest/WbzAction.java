...
public class WbzAction implements Action {
    public WbzAction() {
    }
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        try {
            ...
            rs.executeSql("select jmsjid from formtable_main_384_dt9 where mainid = (select id from formtable_main_384 where requestid=" + requestid + ")");
