...
/**
 * ALP-17.预付款申请测试---集成到付款单
 */
public class YfksqDjFkd implements Action {
    @Override
    public String execute(RequestInfo info) {
        ...
        new BaseBean().writeLog("YfksqDjFkd url: "+url);
        if (url!=null) {
            ...
            new BaseBean().writeLog("YfksqDjFkd content: "+content);
