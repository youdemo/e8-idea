 ...
 * desc
 */
public class UpdateSupplierchangeInfo implements Action {
    @Override
    public String execute(RequestInfo info) {
        BaseBean log = new BaseBean();
        log.writeLog("UpdateSupplierchangeInfo start");
        ...
        sql = "select sysno,bgzd,oldvalue,newvalue from "+tableName+"_dt2 where mainid="+mainid;
