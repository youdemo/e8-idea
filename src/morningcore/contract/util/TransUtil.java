...
public class TransUtil {
	...
	public String getSelectFieldHtml(String fieldname,String tbname,String value ){
		...
		sql="select selectname,selectvalue from workflow_billfield a, workflow_bill b,workflow_selectitem c where a.billid=b.id and c.fieldid=a.id  and b.tablename='"+tbname+"' and a.fieldname='"+fieldname+"' and isnull(cancel,0)=0 order by isnull(listorder,0) asc,selectvalue asc";
		rs.executeSql(sql);
		while(rs.next()){
