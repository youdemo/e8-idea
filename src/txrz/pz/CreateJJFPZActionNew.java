...
/** 
* @author 作者  张瑞坤
* @date 创建时间：2019年12月12日 上午9:40:15 
* @version 1.0 
*/
public class CreateJJFPZActionNew implements Action{
	...
	public String execute(RequestInfo info) {
		...
		new BaseBean().writeLog("CreateJJFPZActionNew","requestid:"+requestid);
		...
		String FBillNo = "";//	单据编号
		String FBILLTYPEID = "3";//	单据类型 交际费用申请
...
//			Fregion  = Util.null2String(rs.getString(""));//	国别地区
			...
			FreserveAmount  = Util.null2String(rs.getString("byjye"));//	备用金额
...
//			FtravelPlace  = Util.null2String(rs.getString(""));//	出差地点
		...
		while(rs.next()) {
			...
			FPAYEE = Util.null2String(rs.getString("skzh"));//	收款人  账户
