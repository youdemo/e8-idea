...
* @version 1.0 
*/
public class CreateCLFPZActionNew implements Action{
	...
	public String execute(RequestInfo info) {
		...
		new BaseBean().writeLog("CreateCLFPZActionNew","requestid:"+requestid);
		...
		String FBillNo = "";//	单据编号
		String FBILLTYPEID = "1";//	单据类型 差旅费用申请
