...
/** 
* @author 作者  张瑞坤
* @date 创建时间：2019年12月9日 下午5:36:52 
* @version 1.0 
*/
public class CreateZJKPZActionNew implements Action{

	@Override
	public String execute(RequestInfo info) {
		String workflowID = info.getWorkflowid();// 获取工作流程Workflowid的值
		String requestid = info.getRequestid();
		new BaseBean().writeLog("CreateZJKPZActionNew","requestid:"+requestid);
		...
		String FBillNo = "";//	单据编号
		String FBILLTYPEID = "5";//	单据类型 暂借款申请单
...
//			Fcustodian  = Util.null2String(rs.getString(""));//	保管人
...
//			FreserveAmount  = Util.null2String(rs.getString(""));//	备用金额
//			FBorrowMoney  = Util.null2String(rs.getString(""));//	是否暂借款
			FBOrrowAmout  = Util.null2String(rs.getString("je"));//	暂借款金额
...
//			FtravelPlace  = Util.null2String(rs.getString(""));//	出差地点		
			///明细1数据
			FPAYEE = Util.null2String(rs.getString("yhzh"));//	收款人
