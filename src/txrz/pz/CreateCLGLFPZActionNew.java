...
/** 
* @author 作者  张瑞坤
* @date 创建时间：2019年12月12日 下午1:12:00 
* @version 1.0   车辆、办公、房屋费用等申请
*/
public class CreateCLGLFPZActionNew  implements Action{
	...
	public String execute(RequestInfo info) {
		...
		new BaseBean().writeLog("CreateCLGLFPZActionNew","requestid:"+requestid);
		...
		String FBillNo = "";//	单据编号
		String FBILLTYPEID = "2";//	单据类型 车辆、办公、房屋费用等申请
