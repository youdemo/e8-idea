...
* @version 1.0 
*/
public class CreateBYJPZActionNew20200618 implements Action{
	...
	public String execute(RequestInfo info) {
		...
		String FBillNo = "";//	单据编号
		String FBILLTYPEID = "备用金支用表";//	单据类型
...
//			FBOrrowAmout  = Util.null2String(rs.getString(""));//	暂借款金额
			...
			FREQUESTDEPTID  = gu.getFieldVal("hrmdepartment", "departmentcode", "id", rs.getString("qkdw"));//	申请部门
