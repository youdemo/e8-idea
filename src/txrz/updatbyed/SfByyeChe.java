...
/**
 * @author 作者  张瑞坤
 * @version 创建时间：2019-2-21 下午4:05:54
 * 车辆释放
 */
public class SfByyeChe implements Action {
	...
	public String execute(RequestInfo info) {
		...
		String sql = "select sfsybyj,wssrzh,byjk from "+tablename+" where requestid = '"+requestid+"'";
		rs.executeSql(sql);
		if(rs.next()){
