...
public class ChangeMoneyEnglish {
    public static String parse(Object x) {
        if (x != null) {
            return parsemoney(x + "");
        } else {
            return "";
    ...
    private static String parsemoney(String x) {
    ...
    public static void main(String[] args) {
        System.out.println("*** " + parse("100.23"));
        System.out.println("*** " + parse("2100"));
    }
}
