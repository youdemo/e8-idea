...
/** 
* @author 作者  张瑞坤
* @date 创建时间：2020年5月17日 下午3:49:40 
* @version 1.0 
*/
public class FinalUtil {
	...
	public final static String method_kyys = "validateUsableBudget";//可用预算
	public final static String appToken_kyys = "CONTROLLER_1";//可用预算
	public final static String loginToken_url = "http://10.66.52.214:8080/intcubecss/css/WS";//登录token
