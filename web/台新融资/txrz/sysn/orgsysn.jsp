...
<%@ page import="txrz.sysn.org.SysnOrgDataJob" %>
...
%>
	...
	<FORM id=report name=report action=/txrz/sysn/orgsysn.jsp method=post>
		...
		if("1".equals(multiIds)){	
			boolean isOver = true;
			SysnOrgDataJob sord = new SysnOrgDataJob();
			sord.execute();
...
<wea:group context="同步组织架构" attributes="test">
	...
	<wea:item>&nbsp;&nbsp;</wea:item>
		...
		<table width="30%">
			...
			<tr>
				<td><input name="hi1" type="button" value="同步" class="e8_btn_top_first" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;  max-width: 100px;width:100px;height:30px;font-size:15px;" onClick="onCheckup()"></td>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<script type="text/javascript">	
				...
				function onCheckup(){
					 ...
					 top.Dialog.confirm('是否同步组织架构？',function(){
       					 document.report.multiIds.value = "1";
						document.report.submit();
   					 });
