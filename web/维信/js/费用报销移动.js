...
var sfcbys_dt1= "128582";//明细1是否超标颜色
            ...
            if( jQuery(sjbxje_dt1+index).length>0){
                ...
                if(bxxm_dt1_val == "67" && yfje_dt1_val != "" && sjbxje_dt1_val != ""){
                    if(Number(yfje_dt1_val)<Number(sjbxje_dt1_val)){
                        ...
                        jQuery("#isshow0_"+index+"_"+sjbxje).text(yfje_dt1_val);
                    }
                }
                var sjbxje_dt1_val = jQuery(sjbxje_dt1+index).val();
...
function changecolor(index){
    ...
    if(sfcb_dt1_val == "1"){
        jQuery("#isshow0_"+index+"_"+sfcbys_dt1).parent().parent().parent().css({"background-color":"yellow"});
    }else{
        jQuery("#isshow0_"+index+"_"+sfcbys_dt1).parent().parent().parent().removeAttr("style","");
    }
}
//增加必填
