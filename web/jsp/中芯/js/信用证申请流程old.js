...
jQuery(document).ready(function(){
    var checkarr1 = ANYBANK +","+ISSUINGBANK+","+NEGOTIATION+","+ACCEPTANCE+","+PAYMENT+","+DEFERRED;
    ...
    var checkarr2 = SIGHT +","+DAYSAFTER2+","+DRAFTSAGAINSTACCEPTANCE+","+ISSUINGBANK2+","+FOR_C;
    bindclickfun(checkarr2);
    var checkarr3 = FOB +","+CFR+","+CIF+","+FCA+","+OTHER;
    bindclickfun(checkarr3);
    bindclickfun(D1);
    var checkarr3 = D2 +","+D2_1+","+D2_4+","+D2_5+","+D2_6+","+D2_7;
    bindclickfun(checkarr3);
    bindclickfun(D3 +","+D3_3+","+D3_4);
    bindclickfun(D4);
    bindclickfun(D5);
    bindclickfun(D6);
    bindclickfun(D7);
