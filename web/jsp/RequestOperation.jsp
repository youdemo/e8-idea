...
String fromofs = Util.null2String(fu.getParameter("fromofs"));
...
String isSubmitDirect = Util.null2String(fu.getParameter("isSubmitDirect"));
...
workflowRequestInfo.setIsSubmitDirect(isSubmitDirect);
...
if("submit".equals(src)||"subnoback".equals(src)||"subback".equals(src)||"supervise".equals(src) ||"intervenor".equals(src) ){
    ...
    result = wfs.deleteRequest(Util.getIntValue(requestid), user.getUID())?"success":"fail";
...
if(fromofs.equals("1")||(!"1".equals(mobileWFOffice)&&"client.jsp".equals(fromPage))
	||("1".equals(mobileWFOffice)&&"client.jsp".equals(fromPage)&&!"save".equals(src)||("create".equals(method2)&&"client.jsp".equals(fromPage)))){
		String mobileurl = "";
		RecordSet.executeSql("select mobileurl from uf_oa_mobileurl");
		if(RecordSet.next()){
			mobileurl = Util.null2String(RecordSet.getString("mobileurl"));
		}
		%>
<script type="text/javascript">
		//function submitResult(){	
			var mobileurl = "<%=mobileurl%>";
			location.href=mobileurl+"/workflow/workflow/WfRefreshList.jsp";
		//}	    
</script>
<% }else{%>
<html><head>
