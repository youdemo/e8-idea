...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "htwfcsnode01";
	...
	<BODY>
		...
		<FORM id=report name=report action="/htkj/workflow/report/ht-workflow-cs-node-list.jsp" method=post>
		...
		<%
		String backfields = "logid,workflowid,'"+showdate+"' as lastoperatedate,nodeid,cssl,( select workflowname from workflow_base where id=t.workflowid) as workflowname,(select nodename from workflow_nodebase where id=t.nodeid) as nodename";
		String fromSql  =  " from (" +
				"   select max(logid) as logid,a.workflowid,b.nodeid,count(1) as cssl " +
		...
		fromSql	+="   and b.nodeid in (select distinct jdid from uf_workflow_csmt)" +
				...
				"   group by a.workflowid,b.nodeid ) t";
		String sqlWhere =  " 1=1 ";
		...
		String orderby =  " cssl desc,workflowid asc,nodeid asc "  ;
		String tableString = "";
		...
		"			<head>";
				tableString +="<col width=\"20%\" text=\"流程名称\" column=\"workflowname\" orderkey=\"workflowname\" />"+
						...
						"<col width=\"20%\" text=\"相关流程\" column=\"nodeid\" orderkey=\"nodeid\" transmethod=\"htkj.workflow.report.CsUtil.csTransView\" otherpara=\"column:lastoperatedate\"/>"+
						"</head>"+
		 "</table>";
	//showExpExcel="false"
	%>
	...
	<script type="text/javascript">
		...
		function refersh() {
  		...
  		function showrequest(nodeid,lastoperatedate){
			var title = "";
			var url = "";

				title = "";
				url="/htkj/workflow/report/ht-workflow-cs-node-request-Url.jsp?nodeid="+nodeid+"&lastoperatedate="+lastoperatedate;
