...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "htwfcsnoderq01";
    String nodeid = Util.null2String(request.getParameter("nodeid"));
    String lastoperatedate = Util.null2String(request.getParameter("lastoperatedate"));
    String startdate = lastoperatedate.split("~")[0];
    String enddate = lastoperatedate.split("~")[1];
	...
	<BODY>
		...
		<FORM id=report name=report action="/htkj/workflow/report/ht-workflow-cs-node-list-request.jsp" method=post>
		...
		String fromSql  =  "from (" +
				"     select a.requestid,a.requestnamenew,a.creater,createdate,currentnodeid" +
				...
				"   and b.nodeid ="+nodeid +
				"   and a.lastoperatedate>='"+startdate+"'" +
				"   and a.lastoperatedate &lt;='"+enddate+"'" +
