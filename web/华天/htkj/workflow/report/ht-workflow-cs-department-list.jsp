...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<%
		String backfields = "logid,workflowid,'"+showdate+"' as lastoperatedate,departmentid,cssl,( select workflowname from workflow_base where id=t.workflowid) as workflowname";
		String fromSql  =  " from (" +
		...
		fromSql	+="   and b.nodeid in (select distinct jdid from uf_workflow_csmt)" +
				...
				"   group by a.workflowid,c.departmentid ) t";
		String sqlWhere =  " 1=1 ";
		...
		String orderby =  " cssl desc,workflowid asc,departmentid asc "  ;
		String tableString = "";
