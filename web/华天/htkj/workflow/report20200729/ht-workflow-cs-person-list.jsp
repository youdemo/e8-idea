...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<%
		String backfields = "logid,workflowid,lastoperatedate,operator,cssl,( select workflowname from workflow_base where id=t.workflowid) as workflowname";
		String fromSql  =  " from (" +
				"   select max(logid) as logid,a.workflowid,a.lastoperatedate,b.operator,count(1) as cssl" +
		...
		fromSql	+="   and b.nodeid in (select distinct jdid from uf_workflow_csmt)" +
				...
				"   group by a.workflowid,a.lastoperatedate,b.operator ) t";
		String sqlWhere =  " 1=1 ";
		...
		String orderby =  " workflowid asc,lastoperatedate asc,operator asc "  ;
		String tableString = "";
