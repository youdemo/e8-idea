...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<%
		String backfields = "logid,workflowid,lastoperatedate,nodeid,cssl,( select workflowname from workflow_base where id=t.workflowid) as workflowname,(select nodename from workflow_nodebase where id=t.nodeid) as nodename";
		String fromSql  =  " from (" +
		...
		fromSql	+="   and b.nodeid in (select distinct jdid from uf_workflow_csmt)" +
				...
				"   group by a.workflowid,a.lastoperatedate,b.nodeid ) t";
		String sqlWhere =  " 1=1 ";
		...
		String orderby =  " workflowid asc,lastoperatedate asc,nodeid asc "  ;
		String tableString = "";
