...
String isfwlc="0";
int hasfwwfid=0;
String sqlqx="select count(1) as count from uf_cancel_workflow where workflowid='"+workflowid+"'";
RecordSet.execute(sqlqx);
if(RecordSet.next()){
	hasfwwfid = RecordSet.getInt("count");
}
if(hasfwwfid>0){
	isfwlc="1";
}

if(haveStopright && "0".equals(isfwlc))
{
...
if(haveCancelright && "0".equals(isfwlc))
{
