    ...
    <table id="topTitle" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="rightSearchSpan" style="text-align:right;">
				<input type=button class="e8_btn_top" onclick="locking();" value="锁定">
                <input type=button class="e8_btn_top" onclick="calOneDialog();" value="单条付款">
		<input type=button class="e8_btn_top" onclick="calMoreDialog();" value="批量付款">
...
<%
    ...
    String sqlWhere = " 1=1 and (x.lockstatus = '1' or x.lockstatus is null) and x.hzzfje &gt; (select isnull(sum(bcfke),0.00) from formtable_main_265 where  re_ID = x.requestid ) ";//where条件   ???待定
...
<script type="text/javascript">
	...
	var title = "单笔付款处理";
	var url = "/morningcore/purchasev1/financeSure1.jsp?dialog=1&ids=" + ids;
	...
	var title = "批量付款处理";
	var url = "/morningcore/purchasev1/financeSure2.jsp?dialog=1&ids=" + ids;
	diag_vote = new window.top.Dialog();
	diag_vote.currentWindow = window;
	...
	function locking(){
        ...
        //异步修改数据库值
        var tbsj = {
            url: "/morningcore/financev1/updatestatus.jsp?version="+new Date()+"&red="+ids+"&type=0", 
            type: 'get',
