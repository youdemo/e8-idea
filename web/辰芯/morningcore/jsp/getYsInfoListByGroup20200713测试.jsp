...
<%
    ...
    String late_pageId = "morningcore_reportYs_listbygroup001";
...
<%
    String backfields = " * ";
    //表单中的字段
    String fromSql = " from get_YsInfoByGroup_view "; // sql查询的表
    ...
    tableString += "           <col width=\"20%\"  text=\"项目名称\" column=\"xmmc\" orderkey=\"xmmc\" />" +
            ...
            "           <col width=\"15%\" text=\"统一预算科目\" column=\"tyfkmc\" orderkey=\"tyfkmc\" />" +
            "           <col width=\"15%\" text=\"预算年度\" column=\"nf\" orderkey=\"nf\" />" +
            "           <col width=\"15%\" text=\"总预算\" column=\"zgys\" orderkey=\"zgys\" />" +
            "           <col width=\"15%\" text=\"冻结预算\" column=\"djys\" orderkey=\"djys\" />" +
            "           <col width=\"15%\" text=\"扣减预算\" column=\"ykys\" orderkey=\"ykys\" />" +
            "           <col width=\"15%\" text=\"可用预算\" column=\"kyys\" orderkey=\"kyys\" />" +
            "   </head>" +
            " </table>";
%>
